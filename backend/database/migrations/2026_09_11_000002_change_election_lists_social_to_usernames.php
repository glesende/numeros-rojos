...
return new class extends Migration
{
    public function up(): void
    {
        ...
        Schema::table('election_lists', function (Blueprint $table) {
            $table->string('twitter_user', 100)->nullable()->after('source_url');
            $table->string('instagram_user', 100)->nullable()->after('twitter_user');
        });
    }
    ...
    {
        Schema::table('election_lists', function (Blueprint $table) {
            $table->dropColumn(['twitter_user', 'instagram_user']);
        });
