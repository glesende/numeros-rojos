    ...
    <div className="mb-6">
      <div className="flex flex-wrap items-center gap-3">
        ...
        >
          ...
          Filtros
          {activeCount > 0 && (
            <span className="inline-flex items-center justify-center w-5 h-5 rounded-full bg-rojo text-white text-xs font-bold">
              {activeCount}
            </span>
          )}
        ...
        {onReset && (
          <button onClick={onReset} className="text-sm text-gray-500 hover:text-rojo transition-colors">
            Limpiar filtros
          </button>
        )}
      </div>
