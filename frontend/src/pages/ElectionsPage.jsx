...
export default function ElectionsPage() {
  ...
  usePageMeta({
    ...
    description: 'Las listas que se postulan en las elecciones de Independiente: candidatos, propuestas, compromisos y metas verificables, analizados con el mismo criterio para todas.',
    path: '/elecciones',
  });
  ...
  return (
    <div className="max-w-6xl mx-auto px-4 py-8">
      ...
      <div className="flex items-center gap-2 mb-1">
        ...
        <a
          href={`https://wa.me/?text=${encodeURIComponent('¡Mirá las listas, candidatos y propuestas para las elecciones de Independiente! Todo en Números Rojos 👉 ' + window.location.href)}`}
          target="_blank"
        ...
        <a
          href={`https://x.com/intent/tweet?text=${encodeURIComponent('Las listas, candidatos y propuestas para las elecciones de Independiente. Vía @NumerosRojos 👉 ' + window.location.href)}`}
          target="_blank"
          rel="noopener noreferrer"
      ...
      <button
        ...
        className="text-xs text-rojo hover:underline font-medium mb-6 inline-flex items-center gap-1"
      >
