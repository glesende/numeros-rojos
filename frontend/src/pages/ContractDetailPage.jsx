...
export default function ContractDetailPage() {
  ...
  const pageUrl = `https://www.numerosrojos.net/contratos/${id}`;
  const whatsappMsg = encodeURIComponent(`Mirá el contrato de ${contract.full_name} en Independiente: ${pageUrl}`);
  const twitterMsg = encodeURIComponent(`Mirá el contrato de ${contract.full_name} en Independiente: ${pageUrl}`);

  return (
    <div className="max-w-3xl mx-auto px-4 py-8">
      <div className="flex items-center justify-between mb-4">
        <Link to="/contratos" className="text-rojo text-sm hover:underline inline-block">
