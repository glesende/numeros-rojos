      ...
      <section className="bg-rojo text-white py-10 md:py-16">
        <div className="max-w-4xl mx-auto px-4 text-center">
          ...
          <div className="flex items-center justify-center gap-3">
            ...
            <a
              href={`https://wa.me/?text=${encodeURIComponent('Los datos económicos y deportivos de Independiente, centralizados: contratos, deudas, balances y más. Todo en Números Rojos 👉 https://www.numerosrojos.net')}`}
              target="_blank"
            ...
            <a
              href={`https://x.com/intent/tweet?text=${encodeURIComponent('Los datos que todo socio de Independiente tiene que saber: contratos, deudas, balances y más. Vía @NumerosRojos 👉 https://www.numerosrojos.net')}`}
              target="_blank"
              rel="noopener noreferrer"
      ...
      <section id="rumores" className="max-w-6xl mx-auto px-4 py-4">
        <div className="card overflow-hidden">
          ...
          <div className="flex items-center gap-2 mt-4">
            ...
            <a
              href={`https://wa.me/?text=${encodeURIComponent('¡Mirá los jugadores que suenan para Independiente! Datos y estadísticas en Números Rojos 👉 https://www.numerosrojos.net/#rumores')}`}
              target="_blank"
              rel="noopener noreferrer"
            ...
            <a
              href={`https://x.com/intent/tweet?text=${encodeURIComponent('Los rumores de refuerzos de Independiente con estadísticas reales. Vía @NumerosRojos 👉 https://www.numerosrojos.net/#rumores')}`}
              target="_blank"
              rel="noopener noreferrer"
      ...
      <section id="elecciones" className="max-w-6xl mx-auto px-4 py-4">
        <div className="card overflow-hidden">
          ...
          <div className="flex items-center gap-2 mt-4">
            ...
            <a
              href={`https://x.com/intent/tweet?text=${encodeURIComponent('Las listas, candidatos y propuestas para las elecciones de Independiente. Vía @NumerosRojos 👉 https://www.numerosrojos.net/#elecciones')}`}
              target="_blank"
              rel="noopener noreferrer"
              className="text-gray-400 hover:text-gray-900 transition-colors"
              aria-label="Compartir en X"
      ...
      <section id="derechos" className="max-w-6xl mx-auto px-4 py-4">
        <div className="card overflow-hidden">
          ...
          <div className="flex items-center gap-2 mt-4">
            ...
            <a
              href={`https://x.com/intent/tweet?text=${encodeURIComponent('Los derechos económicos de Independiente sobre sus jugadores, con detalle por cada uno. Vía @NumerosRojos 👉 https://www.numerosrojos.net/#derechos')}`}
              target="_blank"
              rel="noopener noreferrer"
              className="text-gray-400 hover:text-gray-900 transition-colors"
              aria-label="Compartir en X"
