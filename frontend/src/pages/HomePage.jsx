    ...
    <div>
      ...
      <section className="bg-rojo text-white py-10 md:py-16">
        <div className="max-w-4xl mx-auto px-4 text-center">
          ...
          <a
            href="https://wa.me/?text=Mir%C3%A1%20los%20datos%20econ%C3%B3micos%20y%20deportivos%20de%20Independiente%20en%20N%C3%BAmeros%20Rojos%3A%20https%3A%2F%2Fwww.numerosrojos.net"
            target="_blank"
            rel="noopener noreferrer"
            className="inline-flex items-center gap-2 border border-white/40 text-white/90 hover:bg-white/10 font-semibold px-5 py-2 rounded-full transition-all text-sm mt-5"
          >
